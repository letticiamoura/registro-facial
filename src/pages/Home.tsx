...
export default function Home() {
    ...
    const classname="h-40 w-3/4 md:w-1/6 p-3 text-2xl font-medium font-serif text-white bg-blue rounded-md text-center hover:bg-ligth-blue transition-colors hover:scale-105 duration-200";
